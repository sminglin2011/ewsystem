								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<a class="btn btn-xs btn-danger" title="GO GL" >
												<i class="ace-icon fa fa-share bigger-120" title="GoGL"></i>
												<!-- <i class="ace-icon fa fa-reply bigger-120" title="GoGL"></i> ungo gl use	 -->
											</a>
											</div>
											</td>
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 var index = layer.open({
				  type: 2,
				  title: "Edit Account Receiptable",
				  content: 'accountreceiptable/goEdit.do?accountreceiptable_ID='+Id,
