		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="systemparameter/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="SYSTEMPARAMETER_ID" id="SYSTEMPARAMETER_ID" value="${pd.SYSTEMPARAMETER_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="NAME_VALUE" id="NAME_VALUE" value="${pd.NAME_VALUE}" maxlength="255" placeholder="Name Value" title="Name Value" style="width:98%;"/></td>
							</tr>
							<tr>
