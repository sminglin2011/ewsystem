package com.fh.controller.contact.address;
...
import com.fh.service.contact.address.AddressManager;

/** 
 * 说明：Contact module address
 * 创建人：SMing
 * 创建时间：2017-02-12
 */
@Controller
...
public class AddressController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("contact/address/address_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("contact/address/address_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Address到excel");
		...
		titles.add("Block");	//1
		titles.add("Floor");	//2
		titles.add("Unit NO.");	//3
		titles.add("Street");	//4
		titles.add("Building");	//5
		titles.add("Postal Code");	//6
		dataMap.put("titles", titles);
		List<PageData> varOList = addressService.listAll(pd);
		List<PageData> varList = new ArrayList<PageData>();
		for(int i=0;i<varOList.size();i++){
			PageData vpd = new PageData();
			vpd.put("var1", varOList.get(i).getString("BLOCK"));	    //1
			vpd.put("var2", varOList.get(i).getString("FLOOR"));	    //2
			vpd.put("var3", varOList.get(i).getString("UNIT_NO"));	    //3
			vpd.put("var4", varOList.get(i).getString("STREET"));	    //4
			vpd.put("var5", varOList.get(i).getString("BUILDING"));	    //5
