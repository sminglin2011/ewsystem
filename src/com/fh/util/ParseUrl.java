...
public class ParseUrl {  
    ...
    private static final String[] portArray = new String[] { "8080" };  
    ...
    public static ArrayList<String> fetchUrlFromFile(String str) {  
        ...
        while (matcher.find()) {  
        	System.out.println("what is it = " + matcher.group());
...
//        String stringAll = stringBuilder.toString(); 
        String stringAll = "/ewsystem/accountnumberctrl/testThreading";
...
//      int i = 0;  
        for (int i=0; i< 1; i++) {  
            exec.execute(new CallHttpRequest(portArray[0], stringAll, begin, end));  
