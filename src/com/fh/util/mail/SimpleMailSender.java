...
//	     mailInfo.setUserName("shuiming.lin@eastwind.sg");    
//	     mailInfo.setPassword("eastwind+1");//您的邮箱密码    
//	     mailInfo.setFromAddress("shuiming.lin@eastwind.sg");    
...
//	     mailInfo.setValidate(true);    
//	     mailInfo.setUserName("860819952@qq.com");    
//	     mailInfo.setPassword("Lsm870720");//您的邮箱密码    
//	     mailInfo.setFromAddress("860819952@qq.com");    
	     mailInfo.setMailServerHost("smtp.gmail.com");    
	     mailInfo.setMailServerPort("465");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("shuiming.lin@eastwind.sg");    
	     mailInfo.setPassword("eastwind+1");//您的邮箱密码    
	     mailInfo.setFromAddress("shuiming.lin@eastwind.sg");  
	     mailInfo.setToAddress("sminglin2011@gmail.com");    
